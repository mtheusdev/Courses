<template>
  <div>
    ...
    <v-sheet :elevation="6" class="pa-2 primary darken-3">
      <v-icon class="white--text mr-3" >info</v-icon>
      <span class="headline white--text font-weight-light" >Voce pode Salvar & Cattegar os Dados</span>
    </v-sheet>
    <v-sheet :elevation="6" class="pa-2 mt-3 success darken-3">
      <v-icon class="white--text mr-3" >info</v-icon>
