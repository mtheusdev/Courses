			...
			<form class="painel" v-if="!enviado">
				...
				<Rotulo nome="Prioridade">
					<select v-model="prioridade" >
						<option v-for="prioridade in prioridades" :key="prioridade.codigo" :value="prioridade.codigo" :selected="prioridade.codigo == 1" >{{prioridade.nome}}</option>
					</select>
				</Rotulo>
...
export default {
	...
	data(){
		return{
			...
			caracteristicas: [],
			usuario:{ // objeto cria os campos dinamicamente
				email: '',
				senha: '',
				idade: 25
			},
